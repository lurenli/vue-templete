...
import Vue from 'vue'
export function IntNumber() {
    // 针对 el-input 或者 input 做的限制，只能输入正整数(包括0)
    Vue.directive('numberOnly', {
        bind: function (el) {
            let input
            // 普通输入框 和 element ui的输入框
...
// const higher = require('../assets/project/higher.jpg') //导入图片写法
// const lower = require('../assets/project/lower.jpg')
// const target = require('../assets/project/target.jpg')
...
// let reg = new RegExp("(" + obj + ")", "g");
// let newstr = repstr.replace(
//     reg,
//     "<font style='font-family:PingFang-SC-Medium'>" + obj + "</font>"
// );
